...
public class AddEmployeePage extends BasePage {
    ...
    private final By headerTitle = By.xpath("//h6[contains(@class, 'orangehrm-main-title')]");
    private final By formLoader = By.className("oxd-form-loader");


    private final By firstNameValidationError = By.xpath("//div[div[input[@name='firstName']]]/span");
    private final By usernameValidationError = By.xpath("//div[div[label[text()='Username']]]/span");
    private final By passwordValidationError = By.xpath("//div[div[label[text()='Password']]]/span");
    private final By confirmPasswordValidationError = By.xpath("//div[div[label[text()='Confirm Password']]]/span");
    ...
    public AddEmployeePage clickSaveExpectingFailure() {
        findElement(saveButton).click();
        return this;
    }
