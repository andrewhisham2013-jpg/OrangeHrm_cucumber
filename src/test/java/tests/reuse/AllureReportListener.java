...
public class AllureReportListener implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    private void createEnvironmentFile() {
        ...
        try (FileInputStream fis = new FileInputStream("src/main/resources/config.properties")) {
            ...
            log.error("Could not load config.properties file from resources path.", e);
        }
        ...
        properties.setProperty("Project", configProps.getProperty("projectName", "OrangeHRM Automation"));
        properties.setProperty("Environment", "QA");
        properties.setProperty("Execution Type", "Local");
        properties.setProperty("Application URL", configProps.getProperty("url", "N/A"));
        properties.setProperty("Execution Browser", configProps.getProperty("browser", "N/A"));
